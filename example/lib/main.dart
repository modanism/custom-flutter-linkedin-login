...
const String redirectUrl = 'http://localhost:8080/callback';
const String clientId = '77pv0j45iro4cd';
const String clientSecret = 'LQKSW66VfAIrulyQ';
                ...
                MaterialPageRoute<void>(
                  builder: (final BuildContext context) => LinkedInUserWidget(
                    ...
                    onGetUserProfile: (final UserSucceededAction linkedInUser) {
                      ...
                      print('User id: ${linkedInUser.user.sub}');
